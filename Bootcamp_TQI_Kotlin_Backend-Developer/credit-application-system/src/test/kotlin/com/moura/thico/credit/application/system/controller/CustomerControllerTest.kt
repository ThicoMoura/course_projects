...
class CustomerControllerTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Moura"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("12345678909"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("test@test"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua test, 123"))
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Thico"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("F Moura"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("12345678909"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("test@test"))
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "Thico",
        lastName: String = "F Moura",
